...
/// anchor preferences reported by each paragraph. Ported from Origami Text;
/// this rendition reads through Knowledge Space's ParagraphView (the flow
/// toggle stayed behind with Origami Text's reader).
